...
import com.teamdev.studnets.kasianov.calculator.implementation.commands.RightParenthesisCommand;

public class RightParenthesisParser implements MathParser {
    @Override
    public EvaluationCommand parse(ExpressionReader reader) {
        ...
        return new RightParenthesisCommand();
    }
}
