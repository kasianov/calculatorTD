...
import com.teamdev.studnets.kasianov.calculator.implementation.commands.LeftParenthesisCommand;

public class LeftParenthesisParser implements MathParser {
    @Override
